...
################################################################################
## Form generated from reading UI file 'series_show_uiqphSon.ui'
##
...
class Ui_show(object):
    def setupUi(self, show):
        ...
        show.setMinimumSize(QSize(674, 615))
        show.setMaximumSize(QSize(1000, 700))
...
"}")
        ...
        self.info_scrollarea.setGeometry(QRect(0, 0, 639, 1201))
        ...
        self.status_label = QLabel(self.info_scrollarea)
        self.status_label.setObjectName(u"status_label")
        self.status_label.setMaximumSize(QSize(16777215, 25))
...
"}")
        ...
        self.cast_scroll_area.setGeometry(QRect(0, 0, 622, 285))
...
"")
        ...
        self.scroll_content.setGeometry(QRect(0, 0, 674, 570))
    ...
    def retranslateUi(self, show):
        ...
        self.status_label.setText(QCoreApplication.translate("show", u"Status", None))
